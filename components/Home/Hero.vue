<template>
    <section class="min-h-[700px] bg-primary h-screen">
        ...
        <div v-if="ready" class="pb-5 px-[20px] md:px-[80px] h-full container flex justify-center xl:justify-start items-center relative mx-auto">
            ...
            <div class="mt-[8px] flex md:flex-row flex-col gap-[8px]">
              <div class="px-[9px] py-[8px] flex-1 bg-[#ffff] flex flex-col">
                ...
                <div class="relative p-[20px] mt-[10px] border-solid border-[1.5px] border-[#B4B4B4]">
                    ...
                    <client-only><date-picker @input="ChiusuraOrari('start')" :language="it" :highlighted="this.state.highlighted" :disabled-dates="this.state.disabledDates" :id="'data_start'" :input-class="'mypicker'" placeholder="Data ingresso" format="dd/MM/yyyy" /></client-only>
                    
                </div>
               
                 <div class="relative p-[20px] mt-[10px] border-solid border-[1.5px] border-[#B4B4B4]">
                    <img class="top-0 translate-y-[45%] z-[1] absolute left-[11px] " src="/img/clock_icon.png" alt="orario-ingresso" />
                    <select disabled class="z-10 bg-transparent border-0 pl-[50px] absolute top-0 bottom-0 left-0 w-full" id="ora_start">
               ...
               <div class="px-[9px] py-[8px] flex-1 bg-[#ffff] flex flex-col">
                ...
                <div class="relative p-[20px] mt-[10px] border-solid border-[1.5px] border-[#B4B4B4]">
                   ...
                   <client-only><date-picker @input="ChiusuraOrari('end')" :language="it" :highlighted="this.state.highlighted" :disabled-dates="this.state.disabledDates" :id="'data_end'" :input-class="'mypicker'" placeholder="Data uscita" format="dd/MM/yyyy"/></client-only>
                </div>
                 <div class="relative p-[20px] mt-[10px] border-solid border-[1.5px] border-[#B4B4B4]">
                    <img class="top-0 translate-y-[45%] z-[1] absolute left-[11px] " src="/img/clock_icon.png" alt="orario-uscita" />
                   
                    <select disabled class="z-10 bg-transparent border-0 pl-[50px] absolute top-0 bottom-0 left-0 w-full" id="ora_end">
